...
<template>
  <Heading
    ...
    :href="{ name: 'recovery.options.push-notification' }"
    description="Send instant reminders to your customers right in their browser when they leave items in their cart. Set it up once, and your visitors will get friendly, timely alerts that encourage them to complete their purchase."
  />
  <Content>
            ...
            >
              ...
              <div class="acr:*:my-0!">
                ...
                <h3 class="acr:group-hover:hidden!">
                  {{ percentFrom(push.recovered, push.sent) }}%
                </h3>
